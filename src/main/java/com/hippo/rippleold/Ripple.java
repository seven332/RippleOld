...
class Ripple {
    ...
    private static final String TAG = Ripple.class.getSimpleName();
     ...
     */
    public Ripple(RippleOwner owner, Rect bounds, float startingX, float startingY) {
        mOwner = owner;
        mBounds = bounds;
    ...
    public void setup(int maxRadius, int color, float density) {
        ...
        mOpacity = Color.alpha(color) / 2 / 255.0f;
    ...
    private boolean drawSoftware(Canvas c, Paint p) {
        ...
        final int alpha = MathUtils.clamp((int) (255 * mOpacity + 0.5f), 0, 255);
    ...
    public void exit() {
        ...
        final int opacityDuration = (int) (1000 * 1 / WAVE_OPACITY_DECAY_VELOCITY + 0.5f);
